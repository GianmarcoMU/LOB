...
# This code represents the final step of the analysis, it is used to implement the DeepLOB Model.
...
### Before running the code, it is necessary to uncomment lines 34-39 and 45-50 and check 
### that names of file are correct ###
...
dec_train = dec_data[:int(np.floor(dec_data.shape[0] * 0.8)), :] # 0.8 factor can be changed according to the dimension of the validation period.
...
k = 2 # which prediction horizon (k=0 is 20, k=1 is 50 and k=2 is 100)
