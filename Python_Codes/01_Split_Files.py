...
# This code implements step 1 of the analysis. Briefly, this means that it creates
...
for file in Path(folder).glob('*.csv'):
    ...
    data_category_range = data['#RIC'].unique() # We create separate csv files according to the RIC (alias Ticker)
