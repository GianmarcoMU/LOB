...
# downward (3) or steady (2). Here, the method used is the one by Zhang et al.
...
for file in Path(folder).glob('*.csv'):
    ...
    df = df.iloc[100:-100] # Here we drop the last 100 rows for which labels cannot be associated.
    df.reset_index()
